...
Delta Q_N'(u_q)
=
-rac{2\Lambda(q)}{\sqrt q\,\log q},\mathbf 1\mathbf 1^{\mathsf T},
]

where (mathbf 1mathbf 1^{\mathsf T}) is positive semidefinite and (Lambda(q)ge0).
